---
title: "리액트 톺아보기 - Hooks"
date: 2023-09-10 22:30
tags:
- React
description: VDOM, Fiber, 리액트 라이프사이클, 훅을 통해 컴포넌트 상태를 업데이트하는 과정
---
...
이 글은 그중에서도 goidle 님의 [React 톺아보기 - 03. Hooks_1](https://goidle.github.io/react/in-depth-react-hooks_1)를 주제로
공부한 내용입니다.
...
위에서 알아본 것과 같이 리액트는 훅을 통해 컴포넌트 상태를 업데이트하고,
업데이트를 반영할 Work를 Scheduler에 전달하고, Scheduler는 스케줄링된 task를 적절한 시기에 실행한다.
다음 장에서는 reconciler가 Work를 스케줄링하기 위해 하는 사전작업과 스케줄러가 행하는 일들을 더 자세히 알아본다.
